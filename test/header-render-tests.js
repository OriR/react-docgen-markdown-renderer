  ...
  lab.test('with link', () => {
    const renderer = new ReactDocGenMarkdownRenderer({
      ...
      remoteComponentsBasePath:
        'https://github.com/gen-org/component-library/tree/master/some/path',
    });
    ...
    expect(result).to.equal(
      simpleMarkdown({
        link:
          '\nFrom [`MyComponent.js`](https://github.com/gen-org/component-library/tree/master/some/path/MyComponent.js)',
        types: [{ name: 'stringProp', value: 'String' }],
      }),
    );
  });
